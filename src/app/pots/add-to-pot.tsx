    ...
    return(
        <div className="fixed w-full h-screen left-0 top-0 z-[1] bg-[#00000080] flex items-center justify-center">
            <div className="w-2/6 bg-light rounded-xl px-7 pt-4 pb-6">
                ...
                <div className='mb-2'>
                    <h1 className='text-2xl font-semibold mb-1'>Add To {pot.name}</h1>
                    <p className='text-sm text-light-text'>Add money to your pot to keep it separate from your main balance. As soon as you add this money, it will be deducted from your current balance.</p>
                </div>
                <div className="mb-3">
